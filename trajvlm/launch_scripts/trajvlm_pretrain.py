...
# We don't have a `pretrain_segmenter_path` env var convention; default to the run we just trained.
DEFAULT_SEG_CKPT = (
    "/weka/prior-default/chenhaoz/home/open_videotok/results/ckpts/"
